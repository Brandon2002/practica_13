...
app.get('/numbers/:id', (req, res) => {
    res.render('numbers', { number: req.params.id }); //Darle forma a la información en HTML. También recibiendo la información solicitada.//Solicitando el número para evaluar si es par o no y así ejecutar cierta función.
});
